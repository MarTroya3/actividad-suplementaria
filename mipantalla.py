...
class Ui_MainWindow(object):
    ...
    def crear_base(self):
        cursor = conn.cursor()
        cadena_sql = 'CREATE TABLE Empleado (nombre TEXT, sueldo INTEGER, pago_iva FLOAT, sueldo_total FLOAT)'
        try:
    ...
    def guardar_informacion(self):
        ...
        iva = sueldo*0.12
        sueldototal = sueldo + iva
        cadena_sql = """INSERT INTO Empleado (nombre, sueldo, pago_iva, sueldo_total) VALUES ('%s', %d, %s, %s);""" % \
    (nombre, sueldo, iva, sueldototal)
        # ejecutar el SQL
        cursor.execute(cadena_sql)
